...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CYWebviewController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/CYWebviewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '万鸿恩' => '1396855545@qq.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/CYWebviewController.git', :tag => s.version.to_s }
